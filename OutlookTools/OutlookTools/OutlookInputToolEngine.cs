    ...
    public class OutlookInputToolEngine : AlteryxRecordInfoNet.INetPlugin
    {
        ...
        public bool PI_PushAllRecords(long nRecordLimit)
        {
            ...
            { 
                ...
                OutlookEmail email = new OutlookEmail() { UserName = xmlConfig.UserName, Password = xmlConfig.Password, Folder = (WellKnownFolderName)xmlConfig.Folder, AttachmentPath = xmlConfig.AttachmentPath, QueryString = xmlConfig.QueryString/*, RecordLimit = xmlConfig.RecordLimit*/ };
